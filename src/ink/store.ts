...
export type AppMode = 'menu' | 'init' | 'agent' | 'threads' | 'auth' | 'doctor' | 'share' | 'history' | 'status' | 'sync' | 'monitor' | 'collaborate' | 'loading' | 'error' | 'figma-design' | 'figma-auth' | 'figma-logout' | 'agent-command' | 'thread';
