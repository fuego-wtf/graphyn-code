...
describe('SplitScreenInterface Contract', () => {
    let splitScreen;
    const mockTerminalDimensions = { width: 120, height: 40 };
    beforeEach(() => {
    ...
    describe('Layout Calculation', () => {
        ...
        it('should handle minimum terminal size constraints', () => {
            const tinyTerminal = { width: 20, height: 10 };
            ...
            const approvalState = {
                tasks: [
                    { id: '1', title: 'Task 1', description: 'Test task', agent: 'backend',
                        estimatedTime: 300, dependencies: [], status: 'pending' }
                ],
                selectedIndex: 0,
                modified: false,
                approved: false
    ...
    describe('Event Handling', () => {
        it('should handle terminal resize events', async () => {
            const newDimensions = { width: 100, height: 30 };
        ...
        it('should emit performance warnings when targets are exceeded', async () => {
            ...
            await splitScreen.simulateSlowRender(20);
...
//# sourceMappingURL=split-screen-interface.test.js.map