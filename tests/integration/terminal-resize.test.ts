/**
 * T014: Terminal resize handling integration test
 */
...
describe('Terminal Resize Integration Tests', () => {
  ...
  it('should handle terminal resize gracefully', async () => {
    ...
    expect(newLayout.regions.streamingOutput.height).toBeGreaterThan(
      initialLayout.regions.streamingOutput.height
    );
  });
