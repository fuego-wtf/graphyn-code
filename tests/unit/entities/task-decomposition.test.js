...
describe('TaskDecomposition Entity Tests', () => {
    ...
    beforeEach(() => {
        ...
        taskDecomposition = new TaskDecomposition('build user system', mockTasks);
    });
    describe('Constructor and Initialization', () => {
        ...
        it('should calculate total estimated duration', () => {
            const expectedDuration = 300 + 240 + 180;
    ...
    describe('Task Management', () => {
        it('should add new task and update agent assignments', () => {
            ...
            expect(taskDecomposition.estimatedDuration).toBe(840);
        ...
        it('should remove task and update assignments', () => {
            ...
            expect(taskDecomposition.estimatedDuration).toBe(480);
            const frontendTasks = taskDecomposition.agentAssignments.get('frontend');
        ...
        it('should update existing task', () => {
            ...
            expect(taskDecomposition.estimatedDuration).toBe(870);
        });
    ...
    describe('Status Management', () => {
        it('should update status', () => {
            taskDecomposition.updateStatus('pending_approval');
            expect(taskDecomposition.status).toBe('pending_approval');
        });
        it('should validate status transitions', () => {
            expect(() => taskDecomposition.updateStatus('pending_approval')).not.toThrow();
            expect(() => taskDecomposition.updateStatus('analyzing')).toThrow();
        });
        it('should progress through valid status flow', () => {
            taskDecomposition.updateStatus('pending_approval');
            taskDecomposition.updateStatus('approved');
            taskDecomposition.updateStatus('executing');
            taskDecomposition.updateStatus('completed');
            expect(taskDecomposition.status).toBe('completed');
        });
        it('should allow cancellation from any status', () => {
            taskDecomposition.updateStatus('pending_approval');
            taskDecomposition.updateStatus('cancelled');
    ...
    describe('Agent Assignments', () => {
        ...
        it('should reassign task to different agent', () => {
            taskDecomposition.reassignTask('task-2', 'backend');
            const task = taskDecomposition.getTask('task-2');
...
//# sourceMappingURL=task-decomposition.test.js.map